        ...
        function showResult() {
            ...
            $.ajax({
                ...
                data: {
                    costid: $("#costid").val(),
                    name: $("#name").val(),
                    baseDuration: $("#base_duration").val(),
                    baseCost: $("#base_cost").val(),
...
<div id="main">
    ...
    <form action="/updateFee" method="post" class="main_form">
        ...
        <div class="input_info">
            <input id="costid" name="costid" type="text" class="readonly" readonly value="${coster.costId}"/>
        </div>
        <div class="text_info clearfix"><span>资费名称：</span></div>
        <div class="input_info">
            <input id="name" name="name" type="text" class="width300" value="${coster.name}"/>
        ...
        <div class="input_info">
            <input id="base_duration" name="base_duration" type="text" value="${coster.baseDuration}" class="width100"/>
        ...
        <div class="input_info">
            <input id="base_cost" name="base_cost" type="text" value="${coster.baseCost}" class="width100"/>
        ...
        <div class="input_info">
            <input id="unit_cost" name="unit_cost" type="text" value="${coster.unitCost}" class="width100"/>
        ...
        <div class="input_info_high">
                    <textarea id="descr" name="descr" class="width300 height70">${coster.descr}
                    </textarea>
